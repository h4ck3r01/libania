...
@section('content')
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="x_panel">
                <div class="x_title">
                    <h2><i class="fa fa-edit"></i> {{__('views.admin.pessoa.edit.title', ['name' => $pessoa->nome])}}
                    </h2>
                    <div class="clearfix"></div>
                </div>
                <div class="x_content">
                    {!! Form::model($pessoa,['method'=>'PATCH', 'action'=> ['Admin\PessoasController@update', $pessoa->id], 'data-parsley-validate']) !!}
                    <div class="row">
